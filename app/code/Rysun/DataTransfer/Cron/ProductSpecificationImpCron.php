...
use Rysun\SpecificationAttribute\Model\SpecificationAttributeFactory;
use Magento\Catalog\Model\CategoryFactory;
use Rysun\DataTransfer\Helper\Data;


class ProductSpecificationImpCron
{
    ...
    public function __construct(
        ...
        SpecificationAttributeFactory                   $specificationCollection,
    ...
    public function execute()
    {
        ...
        try {
            $model = $this->specificationCollection->create();
