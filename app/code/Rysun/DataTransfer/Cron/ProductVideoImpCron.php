...
class ProductVideoImpCron
{
    ...
    const PRODUCT_VIDEO_IMPORT_PATH = 'archi_import/general/product_video_import_path';
    ...
    public function execute()
    {
        ...
        try {
            ...
            $filePath = $this->helper->getConfigValue(SELF::PRODUCT_VIDEO_IMPORT_PATH);
