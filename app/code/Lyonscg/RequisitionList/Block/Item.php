...
class Item extends \Magento\Framework\View\Element\Template
{
     ...
     * @var bool
     */
    private $isTaxIncluded = false;

    /**
     * @var bool
     */
    private $isTaxExempted = false;
    ...
    {
        $this->isTaxIncluded = boolval($isTaxIncluded);
        return $this;
    }
     ...
     * @return $this
     */
    public function setIsTaxExempted($isTaxExempted)
    {
        $this->isTaxExempted = boolval($isTaxExempted);
        return $this;
    }
    ...
    public function getRequisitionListProduct()
    {
        ...
        try {
            return $this->requisitionListItemProduct->getProduct($item);
     ...
     * @return float|null
     */
    public function getFinalPrice($includingTax = false)
    {
        try {
            $product = $this->requisitionListItemProduct->getProduct($this->getItem());

            return $finalPrice =  $this->catalogHelper->getTaxPrice(
                $product,
