 ...
 */
namespace Lyonscg\RequisitionList\Block\Requisition\Pdf;
...
/**
 * Class Item
 * @package Lyonscg\RequisitionList\Block\Requisition\Pdf
 */
class Item extends \Magento\Framework\View\Element\Template
{
     ...
     * @return float
     */
    public function getFormattedRetailSubtotal()
    {
        return $this->formatProductPrice(
            $this->getRetailPrice($this->displayPriceIncludingTax()) * $this->getItem()->getQty()
        );
    }
    ...
    /**
     * Format subtotal retail price of item excluding tax.
     *
     * @return float
     */
    public function getFormattedRetailSubtotalExcludingTax()
    {
        return $this->formatProductPrice($this->getRetailPrice(false) * $this->getItem()->getQty());
    }
     ...
     * @return float
     */
    public function formatProductPrice($value)
    {
     ...
     * @return string|null
     */
    public function getImageUrl($imageId = 'product_thumbnail_image')
    {
        try {
    ...
    {
        return $this->itemResolver->getFinalProduct($this->itemOptionsLocator->getOptions($this->getItem()));
    }
     ...
     * @return float|null
     */
    private function getRetailPrice($includingTax = false)
    {
        try {
            $product = $this->requisitionListItemProduct->getProduct($this->getItem());
            ...
            return $this->catalogHelper->getTaxPrice(
                $product,
                //$product->getPriceModel()->getBasePrice($this->getItem()->getQty(), $product),
