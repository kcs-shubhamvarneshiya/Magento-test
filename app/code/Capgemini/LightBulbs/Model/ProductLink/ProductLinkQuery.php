...
namespace Capgemini\LightBulbs\Model\ProductLink;
...
class ProductLinkQuery extends \Magento\Catalog\Model\ProductLink\ProductLinkQuery
{
    /**
    ...
    private function convertLinksData(string $productSku, array $linksData, ?array $acceptedTypes): array
    {
        ...
        foreach ($linksData as $linkData) {
            ...
            if ($linkData['link_type'] === 'upsell') {
                $productLink->setQty($linkData['qty']);
            }
