...
class Transport implements TransportInterface
{
    ...
    public function __construct(
        ...
        $scopeConfig = $scopeConfig ?: ObjectManager::getInstance()->get(ScopeConfigInterface::class);
        ...
        $isCRForceRemoveOn = $scopeConfig->isSetFlag('amasty_customform/advanced/cut_off_caret_returns');

        $this->message = $message;
        $this->logger = $logger ?: ObjectManager::getInstance()->get(LoggerInterface::class);
        $this->laminasTransport = new LaminaTransportCustomized($parameters);
    }
