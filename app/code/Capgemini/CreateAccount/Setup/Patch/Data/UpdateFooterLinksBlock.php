...
class UpdateFooterLinksBlock implements DataPatchInterface
{
...
<div class="footer-links" id="vc-footer-links">
    ...
    <div class="link-column">
        <div data-role="collapsible">
            <p class="footer-header" data-role="trigger">WAY TO SHOP</p>
        </div>
        <div data-role="content">
    ...
    <div class="link-column">
        <div data-role="collapsible">
            <p class="footer-header" data-role="trigger">RESOURCES</p>
        </div>
        <div data-role="content">
...
<div class="footer-links">
    ...
    <div class="link-column">
        <div data-role="collapsible">
            <p class="footer-header" data-role="trigger">LEGAL</p>
        </div>
        <div data-role="content">
