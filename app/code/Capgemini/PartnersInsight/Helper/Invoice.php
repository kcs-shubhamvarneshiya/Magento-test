...
class Invoice extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    protected function _convertOrderItem(array $orderItemData)
    {
        ...
        $data['qty_ordered'] = $orderItemData['qtyOrdered'];
        $data['qty_shipped'] = $orderItemData['qtyShipped'];
        $data['tracking'] = $orderItemData['carrier']['trackingNumber'];
        $data['carrier_name'] = $orderItemData['carrier']['name'];
        $data['price'] = $orderItemData['unitPrice']['value'];
        $data['subtotal'] = $orderItemData['subtotal']['value'];
        $data['tracking_url'] = $orderItemData['carrier']['trackingUrl'] ?? '';
    ...
    protected function _convertInvoice(array $orderData)
    {

        $data = [];
        $incrementId = $orderData['invoiceId'];
        $realIncrementId = $orderData['invoiceId'];
        ...
        $order->setCreatedAt($this->convertDate($orderData['invoiceDate']));
    ...
    public function partnersInsightOrderToMagentoOrder(array $orderData)
    {
        ...
        $order = $this->_convertInvoice($orderData['data']);
...
//        }
        ...
        $items = [];
        $itemsData = $orderData['data']['invoiceLines'] ?: [];
    ...
    {
        return $this->orderData['invoiceDate'];
    }
