...
/**
 * Install appointment_url attribute
 */
class CreateAppointmentUrlAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $data = [
            'attribute_code' => 'appointment_url',
            'frontend_label' => 'Appointment URL',
            'frontend_input' => 'text',
            'is_required' => 0
        ];
