...
class Editwishlist extends \Magento\MultipleWishlist\Controller\Index\Editwishlist
{
    /**
     * @var WishlistEditor
     */
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addException($e, __('We can\'t create the project right now.'));
        }

        if (!$wishlist || !$wishlist->getId()) {
            $this->messageManager->addError(__('Could not create a project.'));
        }
