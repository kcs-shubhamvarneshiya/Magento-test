...
namespace Capgemini\MageWorx\Plugin;
...
class Layer extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return array|false
     */
    public function aroundGetLayeredNavigationFiltersData()
    {
        $filterData = [];
        ...
        if (is_array($appliedFilters) && count($appliedFilters) > 0) {
            ...
            foreach ($appliedFilters as $item) {
                if ($item->getFilter() instanceof \Aheadworks\Layerednav\Model\Layer\State\DefaultFilter) {
                    continue;
                }
