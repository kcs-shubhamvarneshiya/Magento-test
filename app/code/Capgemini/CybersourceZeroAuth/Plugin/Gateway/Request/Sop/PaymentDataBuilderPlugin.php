...
namespace Capgemini\CybersourceZeroAuth\Plugin\Gateway\Request\Sop;

use CyberSource\SecureAcceptance\Gateway\Helper\SubjectReader;
use CyberSource\SecureAcceptance\Gateway\Request\Sop\PaymentDataBuilder;
...
class PaymentDataBuilderPlugin
{
    ...
    /**
     * Set payment amount to $0 if zero auth is enabled
     *
