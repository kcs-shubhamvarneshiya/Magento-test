SET @newurl = "https://stage8.visualcomfort.com/";
SET @newenv = "stage8.visualcomfort.com";
SET @newadmin = "https://stage8.visualcomfort.com/";
SET @newadminenv = "stage8.visualcomfort.com";
...
-- Fastly
UPDATE core_config_data SET value = '-fg00eopoai_wJ6pNiGgaMVSIT5giiyU' WHERE path = 'system/full_page_cache/fastly/fastly_api_key';
UPDATE core_config_data SET value = 'HWSv2rGMJEAQj70QPPQyz5' WHERE path = 'system/full_page_cache/fastly/fastly_service_id';
