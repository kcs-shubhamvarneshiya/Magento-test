SET @newurl = "https://stage2.visualcomfort.com/";
SET @newenv = "stage2.visualcomfort.com";
SET @newadmin = "https://stage2.visualcomfort.com/";
SET @newadminenv = "stage2.visualcomfort.com";
...
-- Fastly
UPDATE core_config_data SET value = 'YKsHS7ytbseksUaW_XVn57gIo4roU3vh' WHERE path = 'system/full_page_cache/fastly/fastly_api_key';
UPDATE core_config_data SET value = 'J9l4FceIhIj6rV8wyZjXE5' WHERE path = 'system/full_page_cache/fastly/fastly_service_id';
