SET @newurl = "https://stage5.visualcomfort.com/";
SET @newenv = "stage5.visualcomfort.com";
SET @newadmin = "https://stage5.visualcomfort.com/";
SET @newadminenv = "stage5.visualcomfort.com";
...
-- Fastly
UPDATE core_config_data SET value = 'm_aKNSwkxcMXSMRT1aU5cRbj3Bg3O3KK' WHERE path = 'system/full_page_cache/fastly/fastly_api_key';
UPDATE core_config_data SET value = 'D5dTg1VbveuB3daDSGhW91' WHERE path = 'system/full_page_cache/fastly/fastly_service_id';
